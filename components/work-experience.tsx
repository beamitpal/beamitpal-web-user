...
const sortByIdDesc = <T extends { id: string }>(a: T, b: T) =>
  idCollator.compare(b.id, a.id);
...
export function WorkExperience({
  ...
  const sortedExperiences = [...experiences].sort(sortByIdDesc);
...
export function ExperienceItem({
  ...
  const sortedPositions = [...experience.positions].sort(sortByIdDesc);
