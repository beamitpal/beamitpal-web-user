...
export type TechStackWhereInput = {
  ...
  key?: Prisma.StringFilter<"TechStack"> | string
  title?: Prisma.StringFilter<"TechStack"> | string
  href?: Prisma.StringFilter<"TechStack"> | string
  categories?: Prisma.StringNullableListFilter<"TechStack">
  theme?: Prisma.BoolFilter<"TechStack"> | boolean
}
...
export type TechStackScalarWhereWithAggregatesInput = {
  ...
  key?: Prisma.StringWithAggregatesFilter<"TechStack"> | string
  title?: Prisma.StringWithAggregatesFilter<"TechStack"> | string
  href?: Prisma.StringWithAggregatesFilter<"TechStack"> | string
  categories?: Prisma.StringNullableListFilter<"TechStack">
  theme?: Prisma.BoolWithAggregatesFilter<"TechStack"> | boolean
}
...
export type TechStackCreateInput = {
  ...
  title: string
  href: string
  categories?: Prisma.TechStackCreatecategoriesInput | string[]
  theme?: boolean
}
...
export type TechStackUpdateInput = {
  ...
  categories?: Prisma.TechStackUpdatecategoriesInput | string[]
  theme?: Prisma.BoolFieldUpdateOperationsInput | boolean
}
...
export type TechStackCreatecategoriesInput = {
  set: string[]
}

export type TechStackUpdatecategoriesInput = {
  set?: string[]
  push?: string | string[]
}
...
export type TechStackOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "title" | "href" | "categories" | "theme", ExtArgs["result"]["techStack"]>
...
export interface TechStackDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const techStackWithKeyOnly = await prisma.techStack.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many TechStacks and only return the `key`
   * const techStackWithKeyOnly = await prisma.techStack.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more TechStacks and only return the `key`
   * const techStackWithKeyOnly = await prisma.techStack.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface TechStackFieldRefs {
  readonly key: Prisma.FieldRef<"TechStack", 'String'>
  readonly title: Prisma.FieldRef<"TechStack", 'String'>
  readonly href: Prisma.FieldRef<"TechStack", 'String'>
  readonly categories: Prisma.FieldRef<"TechStack", 'String[]'>
  readonly theme: Prisma.FieldRef<"TechStack", 'Boolean'>
}
